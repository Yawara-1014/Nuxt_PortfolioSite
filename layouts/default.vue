    ...
    <header class="w-64 h-64">
      <div class="w-64 mt-24 ml-2 relative md:fixed">
        <div class="flex">
          ...
          <div>
            <h1 class="font-bold">Yokoyama Ryota</h1>
            <p class="text-xs text-justify">自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄自己紹介の欄</p>
          </div>
        </div>
        <div class="flex justify-around mt-5 text-xs">
          ...
          <a href="https://github.com/Yawara-1014" target="_blank" rel="noopener noreferrer">
            <button>
              <fa-layers full-width class="fa-2x block mx-auto mb-1">
                <fa :icon="faGithub" />
              </fa-layers>
